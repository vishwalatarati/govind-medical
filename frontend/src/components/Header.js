...
const CART_STORAGE_KEY = "cartItems";
const USER_TOKEN_KEY = "userToken"; // Assuming userToken is the key used to store the token
...
function Header() {
  ...
  const handleProfileClick = () => {
    if (isLoggedIn) {
      // Redirect to profile page or perform logout
    ...
    <div>
      <div className={`header ${isActive ? "active" : ""}`}>
        ...
        <div className="navbar">
          <ul className="nav_links">
            <li className="nav_link">
              <Link to={isLoggedIn ? "/user-profile" : "/sign-in"}>
                {isLoggedIn ? "Profile" : ""}
              </Link>
            </li>
        ...
        {/* <div className="profile_button" onClick={handleProfileClick}>
